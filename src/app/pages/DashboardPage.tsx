          ...
          <Card className="bg-gradient-to-br from-slate-900/80 to-slate-950/80 border-slate-800 p-8">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                {/* ---> ADDED: Financial Risk Exposure Warning <--- */}
                {currentRiskScore < 80 && (
                  <div className="mt-6 bg-red-950/30 border border-red-500/20 rounded-lg p-4 flex items-start gap-3">
                    <AlertTriangle className="h-5 w-5 text-red-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <p className="text-sm font-medium text-red-400">
                        💡 Financial Risk Exposure: Critical
                      </p>
                      <p className="text-xs text-red-300/80 mt-1">
                        The {scanResult.stats.critical} critical issues detected here expose the business to potential GDPR fines of up to €20M or 4% of global revenue.
                      </p>
                    </div>
                  </div>
                )}
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-300 mb-4">
                ...
                Bob analyzes your codebase against GDPR, CCPA, COPPA, and PCI-DSS compliance requirements.
              </p>
